...
private typealias CType = CollectionView<Any, Any>
private var collectionView: CType!

private typealias ItemType = CType.AnyHashable
private var manager: CType.DataManager<CType.AnyHashable, ItemType> {
...
class DataManager_SectionIdentifier_ItemIdentifier_AnyHashable: XCTestCase {
